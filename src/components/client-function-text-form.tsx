...
type Props= {
  ...
  label?: string
  initialValue: string
  update: (clientId: string, functionId: string, newText: string) => Promise<boolean>
}

export function ClientFunctionTextForm({ clientId, functionId, label, initialValue, update }: Props) {
  ...
  async function onSubmit() {
    ...
    setLoading(true)
    try {
      const ok= await update(clientId, functionId, text)
