        ...
        <div className="flex flex-1 gap-6 pl-5 md:gap-5 ">
            <nav>
                <ul className="flex items-center">
                    {clients.map(client => (
                        <li key={client.id} className={`flex items-center border-b-shock-color hover:border-b-shock-color hover:border-b-2 h-11 whitespace-nowrap ${path.includes(client.slug) && "border-b-2"}`}>
