    ...
    if (state === "close") {
        ...
        const intervalo = setInterval(async () => {
            ...
            try {
                ...
                if (contador >= LIMIT_TIME) {
                    clearInterval(intervalo);
                    console.log(`¡ALERTA! La instancia ${instanceName} sigue desconectada después de ${LIMIT_TIME * LOOP_TIME} segundos.`);
