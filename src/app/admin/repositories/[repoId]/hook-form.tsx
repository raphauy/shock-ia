...
type Props= {
  ...
  functionId: string
  initialValue: string
  update: (clientId: string, functionId: string, newWebHookUrl: string) => Promise<boolean>
}

export function HookForm({ clientId, functionId, initialValue, update }: Props) {
  ...
  async function onSubmit() {
    ...
    setLoading(true)
    try {
      const ok= await update(clientId, functionId, webHookUrl)
