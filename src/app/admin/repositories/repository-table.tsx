...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
          ...
          <Input className="max-w-xs" placeholder="finalMessage filter..."
              value={(table.getColumn("finalMessage")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("finalMessage")?.setFilterValue(event.target.value)}                
          />
