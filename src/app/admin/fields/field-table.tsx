...
export function DataTableToolbar<TData>({ table }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div className="flex gap-1 dark:text-white items-center">
          ...
          <Input className="max-w-xs" placeholder="required filter..."
              value={(table.getColumn("required")?.getFilterValue() as string) ?? ""}
              onChange={(event) => table.getColumn("required")?.setFilterValue(event.target.value)}                
          />
